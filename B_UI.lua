...
_G.WindowBackgroundColor = Color3.fromRGB(20, 20, 20)
_G.BackgroundItemColor = Color3.fromRGB(30, 30, 30)
_G.SectionColor = Color3.fromRGB(45, 45, 45)
_G.SectionTextColor = Color3.fromRGB(200, 200, 200)
_G.BorderColor = Color3.fromRGB(80, 80, 80)
_G.HighlightColor = Color3.fromRGB(100, 100, 100)

-- Создание основного интерфейса
local interfaceGui = Instance.new("ScreenGui")
interfaceGui.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
interfaceGui.Parent = game.CoreGui

-- Создание кнопки управления
local controlButton = Instance.new("ImageButton")
controlButton.Parent = interfaceGui
controlButton.BackgroundColor3 = _G.WindowBackgroundColor
controlButton.BorderColor3 = _G.BorderColor
controlButton.BorderSizePixel = 3
controlButton.Position = UDim2.new(0.120833337, 0, 0.0952890813, 0)
...
controlButton.MouseButton1Down:Connect(
    function()
...
-- Инициализация цветовых настроек
_G.Color1 = Color3.fromRGB(255, 0, 0)
do
    -- Очистка предыдущего GUI
    local existingGui = game.CoreGui:FindFirstChild("CelkaHub")
    if existingGui then
        existingGui:Destroy()
    end
...
function CelkaUI:Window(name, keybind)
    local uihide = false
    local abc = false
    local currentpage = ""
    ...
    local CELKAHUB = Instance.new("ScreenGui")
    CELKAHUB.Name = "CelkaHub"
    CELKAHUB.Parent = game.CoreGui
    CELKAHUB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

    local osfunc = {}

    local Main = Instance.new("Frame")
    Main.Name = "Main"
    Main.Parent = CELKAHUB
    Main.ClipsDescendants = true
    Main.AnchorPoint = Vector2.new(0.5, 0.5)
    Main.BackgroundColor3 = _G.WindowBackgroundColor
    ...
    WindowStrokemain.Color = _G.BorderColor
    ...
    Top.Parent = Main
    Top.BackgroundColor3 = _G.WindowBackgroundColor
    ...
    Name.Name = "Name"
    Name.Parent = Top
    Name.BackgroundColor3 = _G.SectionTextColor
    ...
    ServerTime.TextColor3 = _G.SectionTextColor
    ...
    ListNof.Parent = CELKAHUB
    ListNof.BackgroundColor3 = _G.BackgroundItemColor
    ...
    function CelkaUI:Nof(txt, tine)
        spawn(function()
            ...
            Nof1.Name = "Nof1"
            Nof1.Parent = ListNof
            Nof1.BackgroundColor3 = _G.BackgroundItemColor
            ...
            Nof2.Name = "Nof2"
            Nof2.Parent = Nof1
            Nof2.BackgroundColor3 = _G.BackgroundItemColor
            ...
            Nof3.Name = "Nof3"
            Nof3.Parent = Nof1
            Nof3.BackgroundColor3 = _G.BackgroundItemColor
            ...
            NofLabel.BackgroundColor3 = _G.BackgroundItemColor
            ...
            tween:Create(slidenof, tweeninfo(tine or 2), {
                Size = UDim2.new(0, 0, 0, 7)
            }):Play()
            wait(tine or 2)
            Slide2.Visible = true
            tween:Create(Slide2, tweeninfo(0.2), {
            ...
            tween:Create(Nof3, tweeninfo(0.2), {
                Size = UDim2.new(0, 0, 0, 7)
            }):Play()
            tween:Create(NofLabel, tweeninfo(0.2), {
                Size = UDim2.new(0, 0, 0, 52)
            }):Play()
            tween:Create(Nof2, tweeninfo(0.2), {
                Size = UDim2.new(0, 0, 0, 65)
            }):Play()
            wait(0.2)
            Nof2.Visible = false
    ...
    function CelkaUI:Notification(textdesc)
    ...
    WindowStrokelol.Color = _G.BorderColor
    ...
    WindowStrokeshit.Color = _G.BorderColor
    ...
    function uitab:Tab(text, img)
        ...
        function main:Button(text, callback)
            ...
            TextBtn.MouseButton1Click:Connect(function()
                TextBtn.TextSize = 0
                TweenService:Create(TextBtn, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
                    TextSize = 15
                }):Play()
                callback()
            end)
        ...
        function main:Dropdown(droptitle, list, callback)
            ...
            ImageButton.MouseButton1Click:Connect(function()
                if DropToggled then
                    ...
                    game.TweenService:Create(ImageButton,
            ...
            for i, v in next, list do
                ...
                ItemList.MouseEnter:Connect(function()
                    game.TweenService:Create(ItemList,
                        TweenInfo.new(0.08, Enum.EasingStyle.Linear, Enum.EasingDirection.InOut), {
        ...
        function main:Slider(slidertitle, min, max, start, callback)
            ...
            local function slide(input)
                local slidein = UDim2.new(math.clamp((input.Position.X - SliderButton.AbsolutePosition.X) /
                                                         SliderButton.AbsoluteSize.X, 0, 1), 0, 0, 0)
                    ...
                    if tonumber(SliderBox.Text) then
                        if tonumber(SliderBox.Text) <= max then
                            ...
                            SliderCount:TweenPosition(
                                ...
                                "Linear", 0.05, true)
                            Title_2:TweenPosition(UDim2.new(((tonumber(SliderBox.Text) or min) - min) / (max - min), 0,
                                0, 0), "InOut", "Linear", 0.8, true)
                            pcall(function()
                                callback(Value)
                            end)
                        end
